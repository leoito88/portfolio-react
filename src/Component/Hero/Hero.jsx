...
import WaterDropGrid from '/src/Component/WaterDropGrid/WaterDropGrid.jsx';
...
const Hero = () => {
    ...
    />
                ...
                <Flex className="pop pop1" zIndex={2} mt={['0px',null,null,'-100px']} h={"100%"} position={"relative"} right={['60px',null,null,'130px']} p={"5px 20px"} fontSize={"1rem"} color={color} backgroundColor={bg} border={"none"} borderRadius={"35px"} boxShadow={"0 0 0 3px black, 6px 6px 0px #b1b1b1a1"} alignItems={"center"} justifyContent={"space-between"}>
                ...
                <Flex className="pop pop2" zIndex={2} mt={"-20px"} h={"100%"} position={"relative"} right={['-70px',null,null,'-130px']} p={"5px 20px"} fontSize={"1rem"} color={color} backgroundColor={bg} border={"none"} borderRadius={"35px"} boxShadow={"0 0 0 3px black, 6px 6px 0px #b1b1b1a1"} alignItems={"center"} justifyContent={"space-between"}>
                    <Flex className="pop-cont-num" m={"0"} p={"0"} alignItems={"center"} justifyContent={"space-between"} flexWrap={"0"} fontSize={"2em"}>
